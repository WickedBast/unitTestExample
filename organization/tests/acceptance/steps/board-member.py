...
def step_impl(context):
    context.selenium.find_element_by_xpath("//select[@name='user']/options[text()='Dinesh']").click()
    context.selenium.find_element_by_xpath("//select[@name='organization']/options[text()='Microsoft']").click()
    context.selenium.find_element_by_xpath("//select[@name='designation']/options[text()='Founder']").click()
